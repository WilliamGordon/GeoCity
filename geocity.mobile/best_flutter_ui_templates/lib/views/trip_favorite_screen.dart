...
class TripFavoriteScreen extends StatefulWidget {
  @override
  _TripFavoriteScreenState createState() => _TripFavoriteScreenState();
}

class _TripFavoriteScreenState extends State<TripFavoriteScreen> with TickerProviderStateMixin {
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Icon(FontAwesomeIcons.search, size: 20, color: Colors.white),
                ),
              ),
            ),
          ),
