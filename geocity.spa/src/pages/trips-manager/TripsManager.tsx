...
export const TripsManager = (props: { component: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined; }) => {
      ...
      <Box sx={{ backgroundColor: "#E8E8E8" }}>
        ...
        >
          <Grid item xs={10} sx={{ marginTop: "15px" }}>
            <Card sx={{ backgroundColor: "#ffffff", minWidth: 275, marginBottom: "15px" }}>
